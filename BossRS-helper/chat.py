...
class Chat:
    ...
    def generate_letter(job_description):
        ...
        prompt = (
            """
            你将扮演一位求职者的角色,根据上下文里的简历内容以及应聘工作的描述,直接给HR写一个礼貌专业且字数严格限制在120字以内的求职消息,要求能够用专业的语言结合简历中的经历和技能,并结合应聘工作的描述来阐述自己的优势,尽最大可能打动招聘者。始终使用中文来进行消息的编写。开头是你好, 结尾没有多余的内容。这是一份求职消息，不要包含求职内容以外的东西,例如“根据您上传的求职要求和个人简历,我来帮您起草一封求职邮件：”这一类的内容，以便于我直接自动化复制粘贴发送。
            工作描述: """
            + job_description
            + """
            简历内容:"""
